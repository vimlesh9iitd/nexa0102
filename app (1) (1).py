...
# ─────────────────────────────────────────────────────────────────────────────
#  MOBILE / ANDROID WEBVIEW — viewport + touch meta tags
#  Injected once at the top so every page inherits them.
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("""
...
<style>
/* ── ANDROID WEBVIEW TOUCH OPTIMISATIONS ───────────────────────────────── */
...
body, [data-testid="stAppViewContainer"] { overflow-x: hidden !important; }
/* Hide Streamlit's deploy/menu button in WebView (cleaner native feel) */
[data-testid="stToolbar"], [data-testid="manage-app-button"],
#MainMenu, .viewerBadge_container__r5tak { display: none !important; }
